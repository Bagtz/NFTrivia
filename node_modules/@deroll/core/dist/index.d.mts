...
type RequestType = RollupRequest["request_type"];
type RequestData = RollupRequest["data"];
type AdvanceRequestData = components["schemas"]["Advance"];
type InspectRequestData = components["schemas"]["Inspect"];
type RequestMetadata = components["schemas"]["Metadata"];
...
type NoticeResponse = components["schemas"]["IndexResponse"];
type ReportResponse = {};
type VoucherResponse = components["schemas"]["IndexResponse"];
...
export type { $defs, AdvanceRequestData, AdvanceRequestHandler, App, AppOptions, InspectRequestData, InspectRequestHandler, Notice, NoticeResponse, Payload, Report, ReportResponse, RequestData, RequestHandlerResult, RequestMetadata, RequestType, RollupRequest, Voucher, VoucherResponse, components, operations, paths, webhooks };
